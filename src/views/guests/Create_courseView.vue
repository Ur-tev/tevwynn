      ...
      <main class="flex-1 px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="bg-white rounded-lg shadow p-6 max-w-3xl">
          <form class="space-y-6" action="#" method="POST">
            <div>
              <label for="course-title" class="block text-sm font-medium text-gray-700"
                >Course Title</label
              >
              <input
                type="text"
            ...
            <div>
              <label for="course-code" class="block text-sm font-medium text-gray-700"
                >Course Code</label
              >
              <input
                type="text"
            ...
            <div>
              <label for="meeting-info" class="block text-sm font-medium text-gray-700"
                >Meeting Info</label
              >
              <input
                type="text"
            ...
            <div>
              <label for="max-students" class="block text-sm font-medium text-gray-700"
